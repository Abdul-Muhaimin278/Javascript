...
// setTimeout(() => delayedFunction(5), 10000);

// function delayedFunction(x) {
// 	console.log(
// 		"Set timeout is used to set time after which the block of code will be executed.",
// 		5
// 	);
// }

// setTimeout(delayedFunction, 1500);
// setTimeout(() => delayedFunction(5), 4938);
...
// setInterval(repeatedFunction, 100);
