...
const addDaysToDate = (date, extraDay) => {
	...
	// // return new Date(date.setDate(23));
...
// Example usage:
const date1 = new Date("2024-05-19");
const date2 = new Date("2024-06-16");
console.log(getDaysDifference(date1, date2)); // Output: 28 (difference in days)
